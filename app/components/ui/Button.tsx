...
interface ButtonProps
  ...
  > {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'gold' | 'emerald' | 'danger';
  size?: 'sm' | 'md' | 'lg' | 'xl';
  loading?: boolean;
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      danger:
        'bg-gradient-to-br from-red-600 to-rose-600 text-white shadow-lg shadow-red-500/30 hover:shadow-red-500/50',
    };
