...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('warhex_access_token', result.accessToken);
      localStorage.setItem('warhex_refresh_token', result.refreshToken);
      localStorage.setItem('warhex_user', JSON.stringify(result.user));
      router.push('/');
    } catch (err) {
