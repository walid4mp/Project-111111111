...
export default function TournamentDetailsPage() {
  ...
  const tournament = tournaments.find((item) => item.id === params.id) ?? tournaments[0] ?? null;
  if (!tournament) return <div className="min-h-screen grid place-items-center p-6"><Card variant="glass"><p className="text-gray-300">No tournaments are available yet.</p><Link href="/tournaments" className="text-blue-400">Back to tournaments</Link></Card></div>;
